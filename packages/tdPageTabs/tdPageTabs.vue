  ...
  <div id="td-page-tabs">
    <div class="td-page-tab">
      <ul class="page-tabs-list">
        ...
        <li v-for="tab in tabs" :key="tab.uuid" :class="{'active':activeId === tab.uuid}"
            @click="tabClick(tab)">
    ...
    methods: {
      ...
      * */
      ...
      checkRoute() {
        ...
        this.updateSession()
        if (this.tabs.length > this.maxPage) {
          this.$message({message: `tab页不能超过${this.maxPage}个,请关闭多余tab页`})
          this.removeTab()
        }
      },
      /*
